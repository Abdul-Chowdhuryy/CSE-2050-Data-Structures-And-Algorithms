class LLNode:
    ...
    def add_last(self, item):
        '''Recursively adds an item(node) to the end of a linked list'''
        if self.link == None:
    ...
    def sum_all(self):
        '''Recursively sums all of the data in a linked list'''
        if self.link == None:
            return self.data
        else:
    ...
    def remove_all(self, item):
        """Recursively removes all occurrences of the given item from the linked list"""
        if self.data == item:
            if self.link is not None:
    ...
    def reverse(self):
        '''Recursively reveres the linked list'''
        if self.link == None:
            return self
        else:
            reversed_head = self.link.reverse()
            self.link.link = self
            self.link = None
